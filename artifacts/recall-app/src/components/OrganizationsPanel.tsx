...
/**
 * Vendors/contractors + invoices — folded into the People page as a tab
 * (Sidebar Consolidation). Also rendered standalone at /organizations for
 * anyone with an old bookmark/deep link.
 */
